...
class PagosCheques extends React.Component{
  ...
  handleClick =(e)=>{
    let numeroCheque = document.getElementsByName('numeroCheque')[0].value
    if(numeroCheque !== ''){
      let banco = document.getElementById("cboBanco").value;
      if(banco !== ''){
        let numeroFactura = document.getElementsByName('numero de factura')[0].value
        if(numeroFactura !== ''){
          let tipoPago = document.getElementById("cboTipoPago").value;
          if(tipoPago !== ''){
            ...
            if(fecha !== ''){
              ...
              if(monto !== ''){
                ...
                if(hojaRuta !== ''){
                  ...
                  alert("No sea a ingresado informacion en el campo hoja de ruta");
                }
              }else{
                alert("No sea a ingresado informacion en el campo monto");
              }
            }else{
              alert("No sea a ingresado  informacion en el campo fecha de vencimiento");
            }
          }else{
            alert("No sea a seleccionado informacion en el campo numero de tipo de factura");
          }
        }else{
          alert("No sea a ingresado informacion en el campo numero de factura");
        }
      }else{
        alert("No sea a seleccionado informacion en el campo Banco");
      }
    }else{
      alert("No sea a ingresado informacion en el campo numero de cheque");
    }
  }
                ...
                <tr>
                    <td>
                        ...
                        <font>
                            ...
                            <input className= 'form-control' type = 'text' name = 'numeroCheque' onChange={this.change}/>
                        </font>
                        </div>
                    </td>
