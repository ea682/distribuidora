    ...
    getFactura(numeroCuenta){
        return new Promise(function (resolve, reject){
            try {
                ...
                WHERE fa.numeroFactura = ${numeroCuenta} ORDER  BY fa.id ASC`;
