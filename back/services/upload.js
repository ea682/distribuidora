        ...
        for (let i = 0; i < datos.length; i++) {
            try {
                ...
                if(datos[i]["Cantidad"] >= 1){
                    ...
                    clientesServices.newClienteCarga(datos[i]["RUT Cliente"], datos[i]["Nombre del Cliente"], datos[i]["Dirección del Cliente"], datos[i]["Giro del Cliente"], telefonoCliente);

                    facturaServices.newFacturaCarga(datos[i]["Nombre Doc"], datos[i]["Número del Documento"], datos[i]["Fecha"], datos[i]["Fecha Vencimiento"], datos[i]["RUT Cliente"], datos[i]["Cantidad"], datos[i]["Precio Unitario"], datos[i]["Cod. Producto"], "", datos[i]["Cod. Vendedor"]);
                    ...
                    facturaServices.newFacturaCarga(datos[i]["Nombre Doc"], datos[i]["Número del Documento"], datos[i]["Fecha"], datos[i]["Fecha Vencimiento"], datos[i]["RUT Cliente"], datos[i]["Cantidad"], datos[i]["Precio Unitario"], datos[i]["Cod. Producto"], datos[i]["Num Tipo Doc Asociado"], datos[i]["Cod. Vendedor"]);
                }
            } catch (error) {
                console.log(error)
            }
